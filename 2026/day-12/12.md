...
ps aux | head systemctl status ssh journalctl -u ssh --no-pager | tail
...
echo "revision test" >> revision.txt chmod 644 revision.txt ls -l revision.txt mkdir test-dir cp revision.txt test-dir/

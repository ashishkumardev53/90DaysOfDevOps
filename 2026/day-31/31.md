...
Pulled ubuntu base image
Ran apt-get commands in a temporary container
Created a new layer with curl installed
Set default command to echo message
Tagged final image as my-ubuntu:v1

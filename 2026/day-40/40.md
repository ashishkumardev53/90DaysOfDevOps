...
Error Checklist
Which step failed? - Look for red X
What command ran? - Check for typos
What's the error? - Read output carefully
Exit code? - 0 = success, 1 = error, 127 = not found
Check previous steps - Dependencies installed?
Common Errors
Command not found:

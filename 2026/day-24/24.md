...
Emergency production hotfix - Apply critical fix to main without merging entire develop branch
Backporting - Apply security patch from v2.0 to v1.x maintenance branch
Salvaging work - Rescue valuable commit from abandoned branch
Wrong-branch commits - Move commit from wrong branch to correct one
Selective deployment - Deploy specific improvement to staging for testing
What can go wrong
Problem	Description
